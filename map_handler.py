...
def make_map():
	...
	settings.stairs_down = Object(new_x, new_y, '>', 'stairs', tcod.white, always_visible=True)
	settings.objects.append(settings.stairs_down)
	settings.stairs_down.send_to_back()  # so its drawn below the monstars
